...
def run():
    ...
    with open('/Users/beamsplit/Documents/BILLOW/BillHub/BillHub/Scrapers/Outputs/TD_data.csv','r',encoding='latin-1') as inp:
        ...
        for l,item in enumerate(party_list):
            ...
            party.save()
    #open all deputy & senator information from csv
    with open('/Users/beamsplit/Documents/BILLOW/BillHub/BillHub/Scrapers/Outputs/senator_list.csv','r',encoding='latin-1') as inp:
        reader = csv.reader(inp)
        panel_list = []
